...
// =======================================================
// Các hàm cho Bảng băm Dò Bậc hai (Bài 6 - giống Bài 4)
// =======================================================
...
void initHashTable_QP()
{
    ...
    printf("Da khoi tao bang bam do bac hai rong (Bai 6).\n");
}
...
void insert_QP(int k)
{
    ...
    do
    {
        ...
        if (hashTable_QP[currentIndex].Key == EMPTY_KEY || hashTable_QP[currentIndex].Key == DELETED_KEY)
        {
            ...
            printf("Da them khoa %d vao vi tri %d (do bac hai - Bai 6).\n", k, currentIndex);
            return;
        }
...
void remove_QP(int k)
{
    ...
    do
    {
        ...
        {
            hashTable_QP[currentIndex].Key = DELETED_KEY;
            printf("Da xoa khoa %d tai vi tri %d (Bai 6).\n", k, currentIndex);
            return;
        }
        i++;
    } while (i < KEYSIZE);
...
// Menu và chức năng chính cho Bài 6
void showMenu_Bai6() {
    printf("\n\n");
    printf("****************************************\n");
    printf("* UNG DUNG BANG BAM DO BAC HAI (BAI 6) *\n");
    printf("****************************************\n");
...
int main()
{
    ...
    do
    {
        ...
        case 5:
            ...
            break;
        case 0:
            printf("Thoat chuong trinh Bai 6.\n");
            break;
        default:
